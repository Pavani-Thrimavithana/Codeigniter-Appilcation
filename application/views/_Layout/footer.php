...
<!--
   ...
   <script src="<? base_url('assets/js/bootstrap.min.js'); ?>" integrity="sha384-Atwg2Pkwv9vp0ygtn1JAojH0nYbwNJLPhwyoVbhoPwBhjQPR5VtM2+xf0Uwh9KtT" crossorigin="anonymous"></script>
   -->
</html>